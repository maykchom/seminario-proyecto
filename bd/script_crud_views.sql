...
SELECT PR.ID_PREGUNTA
FROM puestos AS PU
INNER JOIN preguntas AS PR ON PR.ID_PUESTO = PU.ID_PUESTO
WHERE PU.ID_PUESTO = 3 AND PR.ID_ESTADO = 1

--pruebas
SELECT PR.PREGUNTA, COUNT(RE.ID_RESPUESTA) AS TOTALRES
FROM puestos AS PU
INNER JOIN preguntas AS PR ON PR.ID_PUESTO = PU.ID_PUESTO
INNER JOIN respuestas as RE ON RE.ID_PREGUNTA = PR.ID_PREGUNTA
WHERE PR.ID_PREGUNTA = 33 AND PR.ID_ESTADO = 1

SELECT PR.ID_PREGUNTA, PR.PREGUNTA
FROM puestos AS PU
INNER JOIN preguntas AS PR ON PR.ID_PUESTO = PU.ID_PUESTO
WHERE PU.ID_PUESTO = 7 AND PR.ID_ESTADO = 1


-- consultas
SELECT PR.ID_PREGUNTA, PR.PREGUNTA, COUNT(RE.ID_RESPUESTA) AS TOTALRESUESTAS
FROM puestos AS PU
INNER JOIN preguntas AS PR ON PR.ID_PUESTO = PU.ID_PUESTO
INNER JOIN respuestas as RE ON RE.ID_PREGUNTA = PR.ID_PREGUNTA
WHERE PU.ID_PUESTO = 7 AND PR.ID_ESTADO = 1
...
SELECT PR.ID_PREGUNTA, PR.PREGUNTA, COUNT(RE.ID_RESPUESTA) AS TOTALRESPUESTAS
FROM puestos AS PU
INNER JOIN preguntas AS PR ON PR.ID_PUESTO = PU.ID_PUESTO
